...
public class AjaxAction {
    ...
    public void getListeClient() throws ServiceException {
        try {
            ...
            if (!JsonHttpClient.checkJsonObject(smaResultContainer)) {
                throw JsonServletHelper.ServiceMetierCallException(this.smaUrl, "getListeClient");
            }
    ...
    public void rechercherClientParNumero(Integer numero) throws ServiceException {
        try {
            ...
            if (!JsonHttpClient.checkJsonObject(smaResultContainer)) {
                throw JsonServletHelper.ServiceMetierCallException(this.smaUrl, "rechercherClientParNumero");
            }
    ...
    void rechercherClientParDenomination(String denomination, String ville) throws ServiceException {
        try {
            ...
            if (!JsonHttpClient.checkJsonObject(smaResultContainer)) {
                throw JsonServletHelper.ServiceMetierCallException(this.smaUrl, "rechercherClientParDenomination");
            }
