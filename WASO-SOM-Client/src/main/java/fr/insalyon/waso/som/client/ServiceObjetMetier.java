...
public class ServiceObjetMetier {
    ...
    void rechercherClientParDenomination(String denomination, String ville) throws ServiceException {
        try {
            ...
            List<Object[]> listeClients = this.dBConnection.launchQuery("SELECT ClientID, TypeClient, Denomination, Adresse, Ville FROM CLIENT WHERE Denomination = ? ORDER BY ClientID", denomination);
            ...
            throw JsonServletHelper.ServiceObjectMetierExecutionException("Client","getClientParDenomination", ex);
        }
    }
